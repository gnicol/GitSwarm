class @P4Tree
  ...
  addSavedMapping: (branchName, nodePath) ->
    ...
    <li>
      ...
      <div class="saved-branch-name"><span class="saved-branch-name-label">#{@escapeHtml(branchName)}</span><span class="label label-primary default-branch-label">default branch</span><div style="float:right;">
